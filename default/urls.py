...
from .views import picture_add, picture_delete, bestlikes, user_login, verify_view, user_register, cooker_register, Home, \
    add_food, ProfileUser, SettingUser, order, AllFood, orders, close_foods, close_foods_helper, detail, \
    setting_social, changepassword, like_view, time_day, search, Delete,morningfood,lunchfood,supperfood

urlpatterns = [
    path('', Home, name='index'),
    path('logout/', LogoutView.as_view(), name='logout'),
    path('user_login/', user_login, name='login'),
    path('morning/', morningfood, name='morning'),
    path('lunch/', lunchfood, name='lunch'),
    path('supper/', supperfood, name='supper'),
    ...
    path('bestlike/',bestlikes,name='bestli'),
